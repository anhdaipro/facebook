...
const Report=({data,setreport})=>{
    ...
    const [item,setItem]=useState({success_report:false})
    ...
    const submitreport=(e)=>{
        ...
        .then(res=>{
            ...
            const datareport={show:false,reported:true,id:data.id,type:data.type}
            alert('Chúng tôi đã nhận được báo cáo của bạn')
            showreport(datareport)
        })      
    }
    return(
        <div className="tiktok-1bg0j8b-DivContentContainer e1gjoq3k2">
            ...
            <form className="tiktok-si5yni-FormReport ex8pc610">
                <div className="tiktok-i17c8h-DivFormHeader ex8pc612">
                    ...
                    <div onClick={()=>setreport({show:false})} data-e2e="report-card-cancel" class="tiktok-78z7l6-DivCloseButton ex8pc614">
            ...
            <div class="tiktok-1p5movk-DivFormBox ex8pc611"><div>
                ...
                <div class="tiktok-1ihqoma-DivFinishContent ex8pc6118">We’ll review your report and if there is a violation of our Community Guidelines, we’ll take appropriate action.</div>
                    <button class="tiktok-83r0jx-ButtonFinish ex8pc6119">Done</button>
                </div>
            </div>}
        </div>
    )
...
export default connect(mapStateToProps,{showreport})( Report);
