...
const Login=(props)=>{
    ...
    const [formData,setFormData]=useState({password:null,phone:null,username:null})
    const [state,setState]=useState({show_password:false,show_signup:false})
    const setstate=(e,name,value)=>{
    ...
    return(
        <>
                            ...
                            <div class="main-right-login">
                                <div className="_3nZHpB">
                                    <div className="_3mizNj">
                                        <input required value={formData.username} onChange={e => onChange(e)} className="yReWDs" type="text" placeholder="Email or Phone number" autoComplete="on" name="username" maxLength="128"/>
                                    </div>
                                ...
                                <div class="main-right-button"> 
                                    <button onClick={e=>setlogin(e)}>Log In</button>
                                </div>
                                ...
                                <div class="main-right-account">
                                    <button onClick={(e)=>setState({...state,show_signup:true})} id="signup-account">Create New Account</button>
                                </div>
            ...
            <div id="modal">
                {state.show_signup?
                <Formsignup
                    setstate={(e,name,value)=>setstate(e,name,value)}
                />:''}
            </div>
        </>
    )
